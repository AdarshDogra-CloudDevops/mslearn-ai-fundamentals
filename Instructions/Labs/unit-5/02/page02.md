...
1. **File or Folder Selection**  
    ...
    - In the file browser, navigate to avigate to `C:\mslearn-ai-fundamentals\Labs\Allfiles\unit5-lesson2` and then select the file: `NASCAR Champions History Dataset.csv` **(1)** 
