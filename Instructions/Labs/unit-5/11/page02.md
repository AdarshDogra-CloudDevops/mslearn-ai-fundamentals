...
1. **File or Folder Selection**  
    ...
    - In the file browser, navigate to `C:\mslearn-ai-fundamentals\mslearn-ai-fundamentals\Labs\Allfiles\unit5-lesson11` and select the file: **`SC_Basketball_Enhanced.csv`** **(1)** 
