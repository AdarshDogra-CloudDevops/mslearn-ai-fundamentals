...
1. **File or Folder Selection**  
   ...
   - In the file browser, navigate to  `C:\mslearn-ai-fundamentals\mslearn-ai-fundamentals\Labs\Allfiles\unit4-lesson6` and then select the file: `Manufacturing_Customer_Feedback.csv` **(1)** 
