...
1. **File or Folder Selection**  
   - In the file browser, navigate to `C:\mslearn-ai-fundamentals\mslearn-ai-fundamentals\Labs\Allfiles\unit5-lesson8` and then select the file: `SREB_U5_L8_CleanedDataset`  
