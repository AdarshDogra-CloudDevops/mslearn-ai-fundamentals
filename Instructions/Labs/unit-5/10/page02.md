...
1. **File or Folder Selection**  
    ...
    - In the file browser, navigate to `C:\mslearn-ai-fundamentals\mslearn-ai-fundamentals\Labs\Allfiles\unit5-lesson10` and then select the file: `SC_Basketball_Enhanced.csv` **(1)** 
...
1. **File or Folder Selection**  
    ...
    - In the file browser, navigate to `C:\mslearn-ai-fundamentals\mslearn-ai-fundamentals\Labs\Allfiles\unit5-lesson10` and select the file: `SC_Basketball_Enhanced Without PTS Column.csv` **(1)** 
    - Wait for the file to appear under “Upload list”  
    - Click **Next (2)**  
