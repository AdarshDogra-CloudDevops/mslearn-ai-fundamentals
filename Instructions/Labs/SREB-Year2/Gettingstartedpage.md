...
| Environment Duration | Until Azure Consumption Credits are exhausted. | Once the Azure consumption credits are exhausted, please inform our team if you need additional credits. The environment will not be deleted when the credits run out. |
